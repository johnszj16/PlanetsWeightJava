 ...
 * @author Patrick Ross
 */
public class PlanetsWeightJava extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        lbTitle.setStyle("-fx-font-size: 24pt; -fx-text-fill: #0ff000;");
        ...
        primaryStage.setTitle("Planet Weight Calculator");
